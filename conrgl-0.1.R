#Functions for mouse control of simulation and plotting (2D and 3D with menus) by using rgl. Written by Hiroshi C. Ito 2020.05.06. ##
...
plot_menu <- function (){
    ...
    if(flag_hide==0){
        ...
        bgplot3d({par(mai=c(0,0,0,0));
            ...
            ##text(x = seq(corners[1],corners[2],,nlab), y = rep(corners[4]+0.04,nlab), labels=labcol$labs,col=labcol$cols,srt = 0,pos=1,cex=1.3)},bg.color="gray")
